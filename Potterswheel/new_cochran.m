...
m = pwAddS(m, 'scale_A',    0.003, 'global', 1E-9, 1);
...
m = pwAddK(m,'B2',0.1,'global',0.0006,0.6);
m = pwAddK(m,'U1',0.042,'fix');
m = pwAddK(m,'U2');
m = pwAddK(m,'xFwd1'); m = pwAddK(m,'xRev1');
m = pwAddK(m,'xFwd3'); m = pwAddK(m,'xRev3');

m = pwAddK(m,'AXLint1',0.03,'global',0.001,1);
m = pwAddK(m,'AXLint2',0.3,'global',1E-3,1);
m = pwAddK(m,'fElse',0.1,'global',1E-5,1);
m = pwAddK(m,'fD2',0.9,'global',1E-1,1);
m = pwAddK(m,'kRec',0.05,'global',1E-3,1E-1);
m = pwAddK(m,'kDeg',0.002,'global',1E-4,1E-1);

m = pwAddK(m,axlExp);
m = pwAddK(m,gasName,0.001,'global',1E-6,100);
