...
m = pwAddX(m,'Gas'      ,0,'fix',0, 1E20,'#/cell','cell');
...
m = pwAddR(m,'R01',{'AXL'},{'A1'},{'Gas'},'C',[],'k1*r1*(m1)-k2*p1',{'B1','U1'});
m = pwAddR(m,'R02',{'AXL'},{'A2'},{'Gas'},'C',[],'k1*r1*(m1)-k2*p1',{'B2','U2'});
m = pwAddR(m,'R03',{'A1'},{'A12'},{'Gas'},'C',[],'k1*r1*(m1)-k2*p1',{'B2','U2'});
m = pwAddR(m,'R04',{'A2'},{'A12'},{'Gas'},'C',[],'k1*r1*(m1)-k2*p1',{'B1','U1'});
...
m = pwAddR(m,'R11',{'D1'},{'D2'},{'Gas'},'C',[],'k1*r1*k2*(m1)/k3-k4*k5*p1/k6',{'xFwd3','B2','xFwd1','xRev3','U2','xRev1'});
...
m = pwAddS(m, 'scale_tot', 2543,  'local',  1E-6, 1E6);
...
m = pwAddTE(m, 'TE1', 'Gas', 'gasName', 0.01);
m = pwAddU(m,'GasTemp','steps',[-1000 0],[0 gasName]);
m = pwAddC(m,'cell',1);
