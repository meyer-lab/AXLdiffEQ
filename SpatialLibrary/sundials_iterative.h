...
SUNDIALS_EXPORT int ModifiedGS(N_Vector *v, double **h, int k, int p, 
			       double *new_vk_norm);
 ...
 * ClassicalGS routine.                                           
 *                                                                
 * s is a length k array of double which can be used as         
...
SUNDIALS_EXPORT int ClassicalGS(N_Vector *v, double **h, int k, int p, 
...
SUNDIALS_EXPORT int QRfact(int n, double **h, double *q, int job);
...
SUNDIALS_EXPORT int QRsol(int n, double **h, double *q, double *b);
