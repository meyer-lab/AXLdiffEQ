...
SUNDIALS_EXPORT double RPowerI(double base, int exponent);
...
SUNDIALS_EXPORT double RPowerR(double base, double exponent);
...
SUNDIALS_EXPORT double RSqrt(double x);
