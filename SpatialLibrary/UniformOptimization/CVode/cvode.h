 ...
 *        return an approximate value of y(tout). The CV_1.0_STEP
 ...
 * allocated vector yout. If itask is CV_1.0_STEP, then the solver
 ...
 *       yout=y(*tret).
 *
 * itask is CV_NORMAL or CV_1.0_STEP. These two modes are described above.
 *
