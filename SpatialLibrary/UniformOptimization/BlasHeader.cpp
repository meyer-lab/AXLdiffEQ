...
//extern "C" int matlabDiffTPS(double *dataPtr, double AXLin, double *GasIn, int gridIn, double *params, double *tps, int nTps, double *dIn, double endoImpairIn, double degImpairIn) {
//    
//    try {
//        diffusionSolution(dataPtr, AXLin, GasIn, gridIn, params, tps, nTps, dIn, endoImpairIn, degImpairIn);
//    } catch (std::exception &e) {
//        errorLogger(&e);
//        return 1;
//    }
