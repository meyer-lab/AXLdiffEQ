...
typedef int (*CVSpilsPrecSetupFn)(double t, N_Vector y, N_Vector fy,
...
typedef int (*CVSpilsPrecSolveFn)(double t, N_Vector y, N_Vector fy,
...
typedef int (*CVSpilsJacTimesVecFn)(N_Vector v, N_Vector Jv, double t,
...
SUNDIALS_EXPORT int CVSpilsSetEpsLin(void *cvode_mem, double eplifac);
