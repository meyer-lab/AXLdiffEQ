function outter = cLib_diff_profile_pYavg (tps, params, GasIn, Din, endoImpair, degImpair, frac)
...
x = calllib('libOptimize','matlabDiffTPS_pYavg',dataPtr, GasInPtr, length(GasIn), pIn, pTps, length(tps), DinP, endoImpair, degImpair, frac);
